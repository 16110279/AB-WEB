...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('assets/public/fonts/icomoon/style.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('assets/public/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/public/css/bootstrap-datepicker.css')}}">
    <link rel="stylesheet" href="{{asset('assets/public/css/animate.css')}}">
    
    
    <link rel="stylesheet" href="{{asset('assets/public/fonts/flaticon/font/flaticon.css')}}">
    <link rel="stylesheet" href="{{asset('assets/public/css/fl-bigmug-line.css')}}">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover" style="background-image: url(assets/public/images/hero_bg_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        ...
        <div class="nonloop-block-4 owl-carousel" data-aos="fade">
            ...
            <div class="block-38 text-center bg-white p-4">
              <div class="block-38-img">
                <div class="block-38-header"> 
                  <img src="assets/public/images/person_1.jpg" alt="Image placeholder">
          ...
          <div class="item col-md-8 mx-auto">
            <div class="block-38 text-center bg-white p-4">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="assets/public/images/person_2.jpg" alt="Image placeholder">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 mb-5 mb-lg-0 col-lg-3" data-aos="fade">
            ...
            <a href="#" class="mb-3 d-block img-a"><img src="assets/public/images/img_1.jpg" alt="Image" class="img-fluid rounded"></a>
          ...
          <div class="col-md-6 mb-5 mb-lg-0 col-lg-3" data-aos="fade">
            <div class="position-relative unit-8">
            <a href="#" class="mb-3 d-block img-a"><img src="assets/public/images/img_2.jpg" alt="Image" class="img-fluid rounded"></a>
            <span class="d-block text-gray-500 text-normal small mb-3">By <a href="#">Colorlib</a> <span class="mx-2">&bullet;</span> Jan 20th, 2019</span>
            <h2 class="h5 font-weihgt-normal line-height-sm mb-3"><a href="#" class="text-black">Lorem ipsum dolor sit amet consectetur adipisicing elit</a></h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. In pariatur nostrum asperiores corrupti delectus.</p>
            </div>
          ...
          <div class="col-md-6 mb-5 mb-lg-0 col-lg-3" data-aos="fade">
            <div class="position-relative unit-8">
            <a href="#" class="mb-3 d-block img-a"><img src="assets/public/images/img_3.jpg" alt="Image" class="img-fluid rounded"></a>
            <span class="d-block text-gray-500 text-normal small mb-3">By <a href="#">Colorlib</a> <span class="mx-2">&bullet;</span> Jan 20th, 2019</span>
            <h2 class="h5 font-weihgt-normal line-height-sm mb-3"><a href="#" class="text-black">Lorem ipsum dolor sit amet consectetur adipisicing elit</a></h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. In pariatur nostrum asperiores corrupti delectus.</p>
            </div>
          ...
          <div class="col-md-6 mb-5 mb-lg-0 col-lg-3" data-aos="fade">
            <div class="position-relative unit-8">
            <a href="#" class="mb-3 d-block img-a"><img src="assets/public/images/img_4.jpg" alt="Image" class="img-fluid rounded"></a>
            <span class="d-block text-gray-500 text-normal small mb-3">By <a href="#">Colorlib</a> <span class="mx-2">&bullet;</span> Jan 20th, 2019</span>
            <h2 class="h5 font-weihgt-normal line-height-sm mb-3"><a href="#" class="text-black">Lorem ipsum dolor sit amet consectetur adipisicing elit</a></h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. In pariatur nostrum asperiores corrupti delectus.</p>
            </div>
  ...
  <script src="{{asset('assets/public/js/jquery-migrate-3.0.1.min.js')}}"></script>
  ...
  <script src="{{asset('assets/public/js/bootstrap-datepicker.min.js')}}"></script>
