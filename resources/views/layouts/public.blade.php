      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0"><a href="{{url('/')}}" class="text-black h2 mb-0">Alumni<strong>Berbagi</strong></a></h1>
          </div>
          ...
          <div class="col-10 col-xl-10 d-none d-xl-block">
            <nav class="site-navigation text-right" role="navigation">
              ...
              <li <?php if ($nav == 'Home') {echo "class='active'";}?> ><a href="{{url('/')}}">Home</a></li>
              <li <?php if ($nav == 'Lowongan') {echo "class='active'";}?> ><a href="{{url('/lowongan-pekerjaan')}}">Lowongan</a></li>
              <li <?php if ($nav == 'Blog') {echo "class='active'";} ?>><a href="{{url('/blog')}}">Blog</a></li>
                <li <?php if ($nav == 'About') {echo "class='active'";} ?>><a href="{{url('/about')}}">About</a></li>
                <li <?php if ($nav == 'Contact') {echo "class='active'";} ?>><a href="{{url('/contact')}}">Contact</a></li>
