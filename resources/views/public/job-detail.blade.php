            ...
            <div class="p-5 bg-white">
              ...
              <div class="mb-4 mb-md-5 mr-5">
               <div class="job-post-item-header d-flex align-items-center">
                 <h2 class="mr-3 text-black h4">{{$loker->judul}}</h2>
                 <div class="badge-wrap">
                  <span class="bg-danger text-white badge py-2 px-4">Temporary</span>
                 </div>
               </div>
               <div class="job-post-item-body d-block d-md-flex">
                 <div class="mr-3"><span class="fl-bigmug-line-portfolio23"></span> <a href="#">{{$loker->nama_perusahaan}}</a></div>
                 <div><span class="fl-bigmug-line-big104"></span> <span>{{$loker->lokasi}}</span></div>
               </div>
              </div>
