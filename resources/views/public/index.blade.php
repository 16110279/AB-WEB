     ...
     <div class="site-blocks-cover" style="background-image: url(assets/public/images/hero_bg_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row row-custom align-items-center">
          <div class="col-md-10">
            <h1 class="mb-2 text-black w-75"><span class="font-weight-bold">SMK</span> Bisa</h1>
         ...
         <div class="col-md-12">
           ...
           <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 mr-5">
               ...
               <h2 class="mr-3 text-black h4">{{$item->judul}}</h2>
                 <div class="badge-wrap">
                  <span class="bg-primary text-white badge py-2 px-4">Partime</span>
                 </div>
               </div>
               <div class="job-post-item-body d-block d-md-flex">
                 <div class="mr-3"><span class="fl-bigmug-line-portfolio23"></span> <a href="#">{{$item->nama_perusahaan}}</a></div>
               <div><span class="fl-bigmug-line-big104"></span> <span>{{$item->lokasi}}</span></div>
               </div>
              </div>

              <div class="ml-auto">
                <a href="#" class="btn btn-secondary rounded-circle btn-favorite text-gray-500"><span class="icon-heart"></span></a>
              <a href="{{url('/lowongan-pekerjaan/'.$item->slug)}}" class="btn btn-primary py-2">Apply Job</a>
              </div>
           </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-6" data-aos="fade" >
            <h2 class="text-black">About Alumni<strong>Berbagi</strong> </h2>
          </div>
        </div>
