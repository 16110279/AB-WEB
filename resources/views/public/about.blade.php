      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-12 mb-5" data-aos="fade">
            <img src="../assets/public/images/img_1.jpg')}}" class="img-md-fluid" alt="Placeholder image">
          </div>
      ...
      <div class="container">
        ...
        <div class="row top-destination">
          <div class="col-lg-2 col-md-4 col-sm-6 col-12" data-aos="fade">
            <a href="#" class="place">
              <img src="{{asset('assets/public/images/person_1.jpg')}}" alt="Image placeholder">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 col-12" data-aos="fade">
            <a href="#" class="place">
              <img src="{{asset('assets/public/images/person_2.jpg')}}" alt="Image placeholder">
              <h2>Mike Stellar</h2>
              <p>CTO Co-founder</p>
            </a>
          </div>
          <div class="col-lg-2 col-md-4 col-sm-6 col-12" data-aos="fade">
            <a href="#" class="place">
              <img src="{{asset('assets/public/images/person_3.jpg')}}" alt="Image placeholder">
              <h2>Gregg White</h2>
              <p>VP Producer</p>
            </a>
          </div>
          <div class="col-lg-2 col-md-4 col-sm-6 col-12" data-aos="fade">
            <a href="#" class="place">
              <img src="{{asset('assets/public/images/person_4.jpg')}}" alt="Image placeholder">
              <h2>Rogie Knitt</h2>
              <p>Project Manager</p>
            </a>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-6" data-aos="fade" >
            <h2 class="text-black">Why Alumni<strong>Berbagi</strong> </h2>
          </div>
        </div>
